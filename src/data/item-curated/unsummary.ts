...
export const unsummaryCuratedData: CuratedItemData = {
  ...
  comparisonWithCompetitors: [
    {
      feature: "Core Focus",
      fakeface: "AI Media Summarization (Books, Podcasts, Movies)",
      remaker: "Blinkist (Curated Human Book Summaries)",
      deepswap: "Shortform (Detailed Non-fiction Book Guides)",
    },
    {
      feature: "Supported Media",
      fakeface: "Books, Podcasts, Films, Articles",
      remaker: "Non-fiction Books & Audio",
      deepswap: "Non-fiction Books",
    },
    {
      feature: "Processing Speed",
      fakeface: "Instant AI Synthesis",
      remaker: "Pre-written Library",
      deepswap: "Pre-written Editorial",
    },
    {
      feature: "Free Starter Access",
      fakeface: "Yes (Free starter credits)",
      remaker: "7-day trial with paywall",
      deepswap: "Limited preview",
    },
  ],
  faqs: [
    {
